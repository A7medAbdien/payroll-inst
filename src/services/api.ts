...
// Create a function to make Frappe method calls
export const call = (method: string, args = {}) => {
  return request({
    url: method,
    method: 'POST',
    params: args
...
// Initialize Frappe API globally
export const initializeFrappeAPI = () => {
  window.frappe = {
    call,
    request
  };
